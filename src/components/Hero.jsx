          ...
          <div className="flex p-5 gap-5">
            <div className="flex flex-col p-4 space-y-4">
              <div className="p-2 space-y-5 -mt-3">
                <h2 className="font-weight-700 space-y-4 text-7xl text-left text-black sm:text-justify">Technolgy<br/>Designed Just <br/>For You</h2>
            ...
            <div className="flex space-x-4">
              ...
              <div className="bg-red-100 border rounded-md w-[410px] h-[500px] flex items-center bg-gradient-to-t from-white to-transparent border-none place-content-center">
                <div className="flex rounded-full  bg-white p-3 w-20 h-20 items-center absolute z-0 place-content-center ml-72 -mt-40">
